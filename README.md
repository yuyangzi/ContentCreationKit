...
│   └── skills/                # 自定义创作技能
│       ├── article-extractor/
│       ├── article-to-presentation/   # Slidev 演示文稿
│       ├── brainstorming/
...
```bash
# Slidev 演示文稿构建（article-to-presentation 技能使用）
...
| **article-to-presentation** | 文章转 Slidev 演示文稿（B站视频素材） |
