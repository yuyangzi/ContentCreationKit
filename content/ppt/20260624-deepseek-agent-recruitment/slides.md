...
<NcRoiCard label="每周Agent新闻" roi="48 条" color="#a855f7" />

<NcRoiCard label="工程师产出" roi="8x" color="#22d3ee" />

<NcRoiCard label="Anthropic 年化营收" roi="$47B" color="#22d3ee" />

</div>

<span class="nc-text-muted" style="display:block; text-align:center; margin-top:2rem;">Agentic.ai News 2026年6月第三周 · 5个月前营收 $9B · 不是"最近很热"，是每周48条</span>
...
/* ============================================
   动画降级 — 淡入档位（禁用 nc-active 交错动画）
   ============================================ */
.nc-default-inner :deep(> *) {
  opacity: 1 !important;
  transform: translateY(0) !important;
  filter: blur(0) !important;
}
.nc-active .nc-default-inner :deep(> *) {
  opacity: 1 !important;
  transform: translateY(0) !important;
  filter: blur(0) !important;
