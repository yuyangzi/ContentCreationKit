...
读到这你可能会问：一两个越狱也就算了。但Anthropic做AI安全做了这么多年，就不能从根本上堵住这个洞吗？
...
这意味着什么？意味着 Anthropic 做了全世界最领先的AI安全研究，但他们的方法论不是"防住"，而是"早点发现、快速反应、持续学习"。这不是道德选择，是被数学逼出来的务实策略。

好，现在我们终于可以回到 Fable 5 被下架这件事本身。因为它背后的真实故事，比"一个模型因为越狱被封杀"要复杂得多。

---

## 故事的另一半：Anthropic 和白宫的战争

你可能不知道，Fable 5 发布的六个月前，Anthropic 已经和美国政府陷入了法律战。

时间线是这样的：

2025年7月14日，五角大楼给了 Anthropic 一份2亿美元的合同，通过 CDAO（首席数字与人工智能办公室）签署。同批拿到合同的还有 Google、OpenAI、xAI。

2026年1月3日，这套模型被用在了一个具体的军事行动中——抓捕委内瑞拉前总统马杜罗。这不是演习，是实战。这件事让 Anthropic 内部非常不安。

2026年2月24日，美国国防部长 Hegseth 下了最后通牒：三天之内，移除模型上的所有安全护栏。否则后果自负。

CEO Dario Amodei 在两天后（2月26日）公开拒绝了。他给出两条红线：第一，全自主武器——"前沿AI系统的可靠性还不足以驱动全自主武器"，这是他的原话；第二，大规模国内监控。

Hegseth 气得够呛。他在1月13日德克萨斯的一次讲话里说过一段值得全文引用的话：
...
2月27日，特朗普下令所有政府机构停止使用 Anthropic 的产品。Hegseth 更进一步，把 Anthropic 列为"供应链风险"。这个词以前只用在外围敌对实体的头上，从没被用来打过一个美国公司。

3月9日，Anthropic 起诉政府。

3月26日，地方法院发出了禁令——Anthropic 赢了。

4月8日，上诉法院推翻了之前的裁决。理由是：美国军队正处于活跃冲突中，法院不能强迫军队使用一个"不想要的供应商"。

所以当6月9日 Fable 5 发布的时候，Anthropic 已经和政府打了三个月官司了。这个背景，让商务部6月12日那封"因越狱而下架"的禁令，味道变得有点微妙。

我读到的信息让我忍不住去想：这个下架命令到底是因为越狱本身，还是因为商务部和国防部终于找到了一个名正言顺的理由？

还有一个有意思的细节：6月2日，特朗普刚签署了一份AI行政令，里面明确写了"本命令不得解释为授权强制性许可制度"。但商务部的禁令——强制禁止外国人访问——偏偏就是强制性许可制度。白宫、商务部、国防部，三个部门的立场并不一致。
...
我能想到的未来并不美好：安全团队狂补越狱漏洞，政府团队狂写禁令文本，开发者站在中间，看着两边在吵。然后所有人都得面对同一个没人能回答的问题：

在一个数学上注定不安全的世界里，"足够安全"的线，到底画在哪？
...
- Fawzi et al. "Fundamental limits on adversarial robustness." ICML 2015 Workshop.
- Mahloujifar et al. "Strong No Free Lunch Theorem on adversarial robustness." arXiv 1810.04065, 2019.
- Anil et al. "Many-shot Jailbreaking." NeurIPS 2024.
- Anthropic RSP v3.1 (Responsible Scaling Policy).
- Amodei 公开声明, 2026年2月26日.
- Hegseth 德克萨斯演讲, 2026年1月13日.
